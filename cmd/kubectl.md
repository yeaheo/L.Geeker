...
```bash
# 创建集群
$ kubectl config set-cluster kubernetes --certificate-authority=/etc/kubernetes/pki/ca.crt --server="https://192.168.8.71:6443" --embed-certs=true --kubeconfig=/opt/work/default-ns-admin.conf
